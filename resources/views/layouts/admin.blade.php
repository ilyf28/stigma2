                ...
                <ul>
                    ...
                    <li class="parent" style="border-left:5px solid #00BCD4;">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="{{route('admin.hostgroups.index')}}">Host Groups</a></li>
                            <li><a href="{{route('admin.services.index')}}">Services</a></li>
                            <li><a href="{{route('admin.servicegroups.index')}}">Service Groups</a></li>
                            <li><a href="{{route('admin.contacts.index')}}">Contacts</a></li>
                            <li><a href="{{route('admin.contactgroups.index')}}">Contact Groups</a></li>
