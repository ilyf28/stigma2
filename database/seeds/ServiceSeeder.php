...
class ServiceSeeder extends Seeder
{
    ...
    { 
        ...
        $data = [
            ...
            'is_template' => 'Y',
            'data' => '{"name":"local-service","use":"generic-service","max_check_attempts":"4","normal_check_interval":"5","retry_check_interval":"1","register":"0"}',
        ];
